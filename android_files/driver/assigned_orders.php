...
$select = "SELECT o.order_id,o.order_status,o.order_date,o.county_id,o.town_id,o.address,
        c2.first_name,c2.last_name,p.order_cost,p.delivery_cost,p.total_cost 
        FROM orders o 
        INNER JOIN assign a ON o.order_id = a.order_id
        INNER JOIN payment p ON o.order_id = p.order_id
        RIGHT JOIN clients c2 on o.client_id = c2.client_id  
        WHERE o.order_status='3'AND a.emp_id='$staffID' 
